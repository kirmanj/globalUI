...
class ProductListPage extends StatefulWidget {
  ...
  const ProductListPage({super.key, this.id,this.subCategory});
...
class _ProductListPageState extends State<ProductListPage> {
  ...
  Widget build(BuildContext context) {
    ...
    Color backgroundColor = AppColors.categories[Helper.uuidToNumber(widget.id??"")];
    return Scaffold(
                                        ...
                                        children: [
                                          ...
                                          GridView.builder(
                                            ...
                                            itemBuilder: (context,index){
                                              return ProductCard(
                                                productListSnapShot: filteredList[index],
                                              );
                                            },
