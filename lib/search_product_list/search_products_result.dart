...
import 'package:autotruckstore/search_product_list/search_provider.dart';
...
class _SearchProductsResultState extends State<SearchProductsResult> {
  ...
  Widget build(BuildContext context) {
    Color backgroundColor =
        AppColors.categories[Helper.uuidToNumber(widget.searchKey ?? "")];
                        ...
                        children: [
                          GridView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return InkWell(
                                onTap: (){
                                  context.go('/product/${value.products![index].id}');
                                },
                                child: ProductCard(
