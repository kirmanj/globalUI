...
class ProductCard extends StatelessWidget {
  ...
  const ProductCard({Key? key,required this.productListSnapShot}) : super(key: key);
              ...
              child: ClipRRect(
                ...
                child: AspectRatio(
                  ...
                  child: SizedBox(
                    ...
                    Image.network(productListSnapShot['images'][0].toString(),fit: BoxFit.cover,),
                  ),
                ),
              ),
            ),
                    ...
                    Row(
                      ...
                      children: [
                        Expanded(
                          child: Row(
                            children: [
                              Text('${_getPrice(productListSnapShot)} \$', style: TextStyle(fontSize: 16,color: Colors.blue,fontWeight: FontWeight.bold),),
