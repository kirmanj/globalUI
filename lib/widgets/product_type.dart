...
class ProductTypeWidget extends StatefulWidget {
  ...
  const ProductTypeWidget({super.key, required this.type, required this.onClick, required this.isSelected});
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                  color: hovered ? AppColors.primaryColor.withAlpha(100) : Colors.black12,
                  spreadRadius: 1,
                  blurRadius: 5
              )
            ],
        ...
        child: Center(
          child: SizedBox(
              ...
              child: Image.asset(
                ...
                color: widget.isSelected ? AppColors.primaryColor : Colors.grey.shade600,
                fit: BoxFit.contain,
              )
          ),
        ),
